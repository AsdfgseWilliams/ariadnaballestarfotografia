...
export const ui: Record<string, Record<string, Record<string, string>>> = {
    en: {
        ...
        home: {
            'hero.h1': 'Wedding photographer in Barcelona',
            ...
            'about.h2': 'Hi, I’m Ariadna, a wedding photographer based in Barcelona.',
            'about.p1': 'Wedding photographer in Barcelona, also specialising in couples, portraits and family sessions.',
            'about.p2': 'I’m glad you’re here to find out how I’m going to tell your story.',
            'about.p3': 'The day you vowed eternal love to each other? A different photo session as a couple? A session just for you? A beautiful and fun family memory?',
            'about.p4': 'Whatever it is, <span class="underline">I know you and I listen to your wishes</span> so that the final result is as special as you imagine it to be.',
            'about.p5': 'And when the day comes, <span class="underline"> I accompany you</span>  so that you can enjoy every moment and detail with confidence, while I silently portray indescribable emotions for life.',
            'about.quote': 'To succeed, your desire to succeed must be greater than your fear of failure.',
        ...
        about: {
            ...
            'timelineSubtitle': 'WHERE IT ALL STARTED AND WHERE IT IS NOW',

            'timeline.year1': "2012",
            'timeline.title1': "I bought my first camera.",
            'timeline.description1': "I needed it for my photography class at university. That’s how I started practicing and falling in love.",
            'timeline.imgSrc1': "/img/18.webp",
            'timeline.alignment1': "left",

            'timeline.year2': "2017",
            'timeline.title2': "I said yes to photography and started my project.",
            'timeline.description2': "I finished my Fine Arts studies and decided to start my adventure as a photographer.",
            'timeline.imgSrc2': "/img/19-1.webp",
            'timeline.alignment2': "right",

            'timeline.year3': "2018",
            'timeline.title3': "From Barcelona to Lleida.",
            'timeline.description3': "I changed city and settled as a photographer in Lleida, specializing in weddings, couples, solo sessions, and families.",
            'timeline.imgSrc3': "/img/20.webp",
            'timeline.alignment3': "left",

            'timeline.year4': "2023",
            'timeline.title4': "Back to my beloved Barcelona.",
            'timeline.description4': "After a pandemic, I returned to the city where it all started, full of excitement and hope.",
        ...
        form: {
            ...
            'reservationPlaceholder': "What do you want to book?",
            'reservationWedding': "Wedding",
            'reservationCouple': "Couple session",
            'reservationIndividual': "Individual session",
            'reservationFamily': "Family session",
            'reservationOthers': "Others",

            'knownPlaceholder': "Where did you meet me?",
            'knownInstagram': "Instagram",
            'knownGoogle': "Google",
            'knownRecommendation': "Recommendation",

            'details': "Tell me more details",
    ...
    es: {
        ...
        home: {
            ...
            'about.h2': 'Hola, Soy Ariadna, fotógrafa de bodas en Barcelona.',
            'about.p1': 'Fotógrafa de bodas en Barcelona, especializada también en parejas, retratos y sesiones familiares.',
            'about.p2': 'Me alegra que estés aquí para que descubras cómo voy a contar tu historia.',
            'about.p3': '¿El día que os juráis amor eterno? ¿Unas fotos diferentes en pareja? ¿Una sesión solo para ti? ¿Un recuerdo bonito y divertido en familia?',
            'about.p4': 'Sea cual sea, <span class="underline">te conozco y escucho tus deseos</span> para que el resultado final sea tan especial como lo imaginas.',
            'about.p5': 'Y cuando llega el día, <span class="underline">te acompaño</span> para que disfrutes de cada instante y detalle con confianza, mientras voy retratando, silenciosa, emociones indescriptibles para toda la vida.',
            'about.quote': 'Para triunfar, tu deseo de éxito debe ser mayor que tu miedo al fracaso.',
        ...
        about: {
            ...
            'timeline.description1': "La necesitaba para la asignatura de fotografía en la universidad. Así empecé a practicar y enamorarme.",
            'timeline.imgSrc1': "/img/18.webp",
            'timeline.alignment1': "left",

            'timeline.year2': "2017",
            'timeline.title2': "Le digo Sí a la fotografía y emprendo mi proyecto.",
            'timeline.description2': "Finalizo mis estudios en Bellas Artes y decido empezar mi aventura como fotógrafa.",
            'timeline.imgSrc2': "/img/19-1.webp",
            'timeline.alignment2': "right",

            'timeline.year3': "2018",
            'timeline.title3': "De Barcelona a Lleida.",
            'timeline.description3': "Cambio de ciudad y me instalo como fotógrafa en Lleida, especializada en bodas y parejas, sesiones individuales y con familias.",
            'timeline.imgSrc3': "/img/20.webp",
            'timeline.alignment3': "left",

            'timeline.year4': "2023",
            'timeline.title4': "De vuelta a mi querida Barcelona.",
            'timeline.description4': "Una pandemia después vuelvo a la ciudad donde todo empezó, con muchas ganas e ilusión.",
            'timeline.imgSrc4': "/img/21.webp",
            'timeline.alignment4': "right",
        ...
        form: {
            ...
            'reservationPlaceholder': "¿Qué quieres reservar?",
            'reservationWedding': "Boda",
            'reservationCouple': "Sesión de pareja",
            'reservationIndividual': "Sesión individual",
            'reservationFamily': "Sesión en familia",
            'reservationOthers': "Otros",

            'knownPlaceholder': "¿Dónde me has conocido?",
            'knownInstagram': "Instagram",
            'knownGoogle': "Google",
            'knownRecommendation': "Recomendación",

            'details': "Cuéntame más detalles",
